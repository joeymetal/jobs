...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { cel: @phone.cel, observations: @phone.observations, others: @phone.others, tel: @phone.tel }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { cel: @phone.cel, observations: @phone.observations, others: @phone.others, tel: @phone.tel }
    assert_redirected_to phone_path(assigns(:phone))
  end
